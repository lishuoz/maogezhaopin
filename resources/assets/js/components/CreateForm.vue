            ...
            <form method="POST" action="/jobs">
               <div class="columns">
                <div class="column is-half">
                    ...
                    <p class="control">
                        <input class="input is-medium" type="text" placeholder="最多不超过30个字" name="title" required>
                    </p>
                    ...
                    <p class="control">
                        <input class="input is-medium" type="text" placeholder="选填" name="address">
                    </p>

                    <label class="label">职位介绍</label>
                    <p class="control">
                        <textarea class="textarea is-medium" placeholder="选填（最多不超过500字）" name="description"></textarea>
                    </p>
                ...
                <div class="column is-half">
                    ...
                    <p class="control" v-show="contract == 'permanent'">
                        <span class="select is-medium">
                            <select name="salary">
                                <option value="1" selected>10000 - 20000 加元／年</option>
                    ...
                    <p class="control" v-show="contract == 'contract'">
                        <span class="select is-medium">
                            <select name="salary">
                                <option value="1" selected>11 - 20 加元/小时</option>
                    ...
                    <p class="control">
                    <input class="input is-medium" type="text" placeholder="最多不超过15个字" name="contact" required>
                    </p>

                    <label class="label">邮箱地址（必填项）</label>
                    <p class="control">
                        <input class="input is-medium" type="text" placeholder="邮箱地址" name="email" required>
                    </p>

                    <label class="label">联系电话</label>
                    <p class="control">
                        <input class="input is-medium" type="text" placeholder="选填" name="phone">
                    </p>

                    <label class="label">公司网址</label>
                    <p class="control">
                        <input class="input is-medium" type="text" placeholder="选填" name="website">
                    </p>
